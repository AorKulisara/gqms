<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="UploadHC.aspx.cs" Inherits="PTT.GQMS.USL.Web.Forms.UploadHC" MaintainScrollPositionOnPostback="True" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Upload excel (H-C dew point)</li>
          </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class='box box-danger'>
                    <div class="box-header">
                       <h3 class="box-title"><i class="fa fa-upload"></i>&nbsp;&nbsp;Upload excel (H-C dew point data)</h3>
                    </div>
                    <div class="box-body">
...
<asp:Label ID="lblAlert" runat="server" CssClass="text-danger" Text=""></asp:Label><br />
          ...
          OnRowDataBound="gvResult_RowDataBound" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Sampling Point" DataField="HC_NAME" >
                                ...
                                <asp:BoundField HeaderText="Temp." DataField="HC" DataFormatString="{0:#,##0.000}" >
