<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainDoc.Master" AutoEventWireup="true" CodeBehind="OMAhour.aspx.cs" Inherits="PTT.GQMS.USL.Web.Forms.OMAhour" MaintainScrollPositionOnPostback="True" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<input type="hidden" id="ServerAction" name="ServerAction" />
<asp:HiddenField ID="hidOMA_NAME" runat="server" />
            ...
            <div class="col-xs-12">
                <div class='box box-primary-light'>
                    <div class="box-header">
                       <h3 class="box-title"><i class="fa fa-tachometer"></i> OMA hours (Moisture)
     ...
     <asp:GridView ID="gvResult" runat="server" HorizontalAlign="Left" AutoGenerateColumns="False" DataKeyNames="RDATE" GridLines="Both"  
         OnRowDataBound="gvResult_RowDataBound"  ShowFooter="True">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="H2O" DataField="VALUE"  DataFormatString="{0:#,##0.000000}" >
                                    <HeaderStyle CssClass="Table-head-primary cell-center" Width="100px"/>
