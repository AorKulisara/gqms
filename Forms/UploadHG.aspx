<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="UploadHG.aspx.cs" Inherits="PTT.GQMS.USL.Web.Forms.UploadHG" MaintainScrollPositionOnPostback="True" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Upload excel (SPOT Hg)</li>
          </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class='box box-danger'>
                    <div class="box-header">
                       <h3 class="box-title"><i class="fa fa-upload"></i>&nbsp;&nbsp;Upload excel (SPOT Hg data)</h3>
                    </div>
                    <div class="box-body">
...
<asp:Label ID="lblAlert" runat="server" CssClass="text-danger" Text=""></asp:Label><br />
          ...
          OnRowDataBound="gvResult_RowDataBound" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Sampling Point" DataField="HG_NAME">
                                ...
                                <asp:BoundField HeaderText="Hg (ug/cu.m.)" DataField="HG"  DataFormatString="{0:#,##0.000}" >
                                    <HeaderStyle CssClass="cell-center" Width="100px"/>
                                    <ItemStyle CssClass="cell-right cell-Middle cell-border" Width="100px"/>
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Vol.(Lit.)" DataField="VOL" DataFormatString="{0:#,##0.000}" >
                                    <HeaderStyle CssClass="cell-center" Width="100px"/>
                                    <ItemStyle CssClass="cell-right cell-Middle cell-border" Width="100px"/>
                                </asp:BoundField>
