<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="UploadOFF.aspx.cs" Inherits="PTT.GQMS.USL.Web.Forms.UploadOFF" MaintainScrollPositionOnPostback="True" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li class="active">Upload excel (Offshore)</li>
          </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class='box box-danger'>
                    <div class="box-header">
                       <h3 class="box-title"><i class="fa fa-upload"></i>&nbsp;&nbsp;Upload excel (Offshore data)</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <table border="0" class="text-black">
                                ...
                                <tr><td></td><td>Note: The sheet name have to be the same as OGC Main Point</td></tr>
