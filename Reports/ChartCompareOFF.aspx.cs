...
{
    //-- edit 28/06/2019 --
    public partial class ChartCompareOFF : System.Web.UI.Page
    {
        ...
        private void GenerateChart()
        {
            ...
            try
            {
                ...
                if (TmplateList != "")
                {
                    ...
                    " AND SITE_ID IN (SELECT DISTINCT S.SITE_ID FROM O_RPT_FID_DETAIL T INNER JOIN O_OFFSHORE_FID S ON T.FID = S.FID WHERE TID IN (" + TmplateList + ")) " +
