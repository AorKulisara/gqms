...
{
    //-- edit 28/06/2019 --
    public partial class ExcelCompareOFF : System.Web.UI.Page
    {
        ...
        private void WriteXSL()
        {
            ...
            try
            {
                ...
                if (TmplateList != "") //3,2,1,5
                {
                    ...
                    " FROM O_RPT_FID_TEMPLATE T INNER JOIN O_RPT_FID_DETAIL D ON T.TID = D.TID " +
                    "      INNER JOIN O_OFFSHORE_FID S ON D.FID=S.FID " +
                ...
                else
                {
                    ...
                    SQL = " SELECT '' T_NAME, FID, SITE_ID FROM O_OFFSHORE_FID " +
                ...
                {
                    myWorksheet.DeleteRow(rw, 104 - (rw), true);   // Should Delete multi rows and shift up the rows after deletion
