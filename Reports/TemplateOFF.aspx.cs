...
{
    //-- edit 28/06/2019 ---
    public partial class TemplateOFF : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                DT = Project.dal.SearchRptFidTemplate("2", Key, "");
        ...
        private void SaveData()
        {
            ...
            try
            {
                ...
                DT = Project.dal.SearchRptFidTemplate("2", "", TName);
                ...
                {
                    Project.dal.MngRptFidTemplate(OPs, ref Key, TName, "2");
                }
                if (Msg == "")
                {
        ...
        protected void gvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.Footer)
                {
                    ...
                    if (Key == "")
                    {
                        SQL = " SELECT FID  FROM O_OFFSHORE_FID " +
                           "ORDER BY FID ";
                    }
                    else
                    {
