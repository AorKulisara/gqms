...
namespace PTT.GQMS.USL.Web.Reports
{
    ...
    public partial class rptOFF : System.Web.UI.Page
    {
        ...
        protected void gvResult_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.Header)
                {
                    ...
                    cell.ColumnSpan = 11; cell.Width = 770; cell.CssClass = "Table-head-gray"; extraHeader.Cells.Add(cell);
        ...
        private String ConfigCol(int gCol)
        {
            ...
            try
            {
                switch (gCol)
                {
                    ...
                    case 12: result = "C7"; break;
                    case 13: result = "CO2"; break;
                    case 14: result = "N2"; break;
                    case 15: result = "HG"; break;
                    case 16: result = "H2S"; break;
                    case 17: result = "GHV"; break;
                    case 18: result = "SG"; break;
                    case 19: result = "H2O"; break; //H2O
