...
{
    //-- edit 16/08/2018 ---
    public partial class TemplateDetail : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            try
            {
                ...
                DT = Project.dal.SearchRptFidTemplate("1",Key, "");
        ...
        private void SaveData()
        {
            ...
            try
            {
                ...
                DT = Project.dal.SearchRptFidTemplate("1","", TName);
                ...
                {
                    Project.dal.MngRptFidTemplate(OPs, ref Key, TName,"1");
                }
                if (Msg == "")
                {
        ...
        protected void gvData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.Footer)
                {
                    ...
                    //-- dropdown FID ---
                    String ddl = "";
                    //DataTable  DT = Project.dal.SearchSiteFID(orderSQL: " FID ");
                    String SQL = "";
                    if ( Key == "")
                    {
                        SQL = " SELECT FID  FROM O_SITE_FID " +
                           "ORDER BY FID ";
                    }
                    else
                    {
