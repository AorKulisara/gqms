<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="TemplateOFF.aspx.cs" Inherits="PTT.GQMS.USL.Web.Reports.TemplateOFF" MaintainScrollPositionOnPostback="True" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script   type="text/javascript">
        var LastPage = "TemplateListOFF?UID=<%= HttpContext.Current.Session["UID"] %>";
    ...
    <asp:HiddenField ID="hidTID" runat="server" />
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Reports</li>
            <li onclick="javascript:GoMenu('TemplateListOFF');" style="cursor:pointer" >Offshore site template</li>
