<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="TemplateDetail.aspx.cs" Inherits="PTT.GQMS.USL.Web.Reports.TemplateDetail" MaintainScrollPositionOnPostback="True" Explicit="True" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script   type="text/javascript">
        var LastPage = "TemplateList?UID=<%= HttpContext.Current.Session["UID"] %>";
        ...
        function CheckDataAddItem() {
            ...
            if ($("#ddlFID").val() == "") { t_err += "* OGC Main Point \r\n"; }
    ...
    <asp:HiddenField ID="hidTID" runat="server" />
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Reports</li>
            <li onclick="javascript:GoMenu('TemplateList');" style="cursor:pointer" >Onshore site template</li>
            <li class="active">Site template detail</li>
          </ol>
        </section>
        <!-- Main content -->
        <section class="content">
          <div class="row">
            ...
            <div class="box-header">
                <h3 class="box-title">Site template detail</h3>
            </div>
            <div class="box-body">
...
<div class="col-xs-12">
  <table border="0" class="text-black">
	<tr>
		...
		<td style=" width: 600px; text-align: left;"><asp:TextBox ID="txtName" MaxLength="200" runat="server" CssClass="form-control " Width="500px" ReadOnly="True" ></asp:TextBox></td>
	</tr>
 </table>
       <br />
</div> 
               ...
               <asp:GridView ID="gvData" runat="server" HorizontalAlign="Left" AutoGenerateColumns="False" DataKeyNames="SEQ" AllowPaging="False" GridLines="Both" OnRowDataBound="gvData_RowDataBound" Width="600"  >
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="OGC Main Point">
