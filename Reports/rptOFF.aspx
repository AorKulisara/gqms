<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="rptOFF.aspx.cs" Inherits="PTT.GQMS.USL.Web.Reports.rptOFF" MaintainScrollPositionOnPostback="True" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        var NextPage2 = "ExcelOFF?UID=<%= HttpContext.Current.Session["UID"] %>";
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li>Reports </li>
            <li class="active">Offshore Summary</li>
          </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class='box box-success'>
                    <div class="box-header">
                       <h3 class="box-title"><i class="fa fa-file-text "></i> Offshore Summary</h3>
                    </div>
                    ...
                    <div class="box-body">
                        <asp:GridView ID="gvResult" runat="server" HorizontalAlign="Left" AutoGenerateColumns="False" OnRowDataBound="gvResult_RowDataBound"  >
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="C7H16" DataField="" >
                                    <HeaderStyle CssClass="cell-center" Width="70px"/>
                                    <ItemStyle CssClass="cell-right cell-Middle cell-border11" Width="70px"/>
                                </asp:BoundField>
