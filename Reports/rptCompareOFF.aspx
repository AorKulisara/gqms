<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="rptCompareOFF.aspx.cs" Inherits="PTT.GQMS.USL.Web.Reports.rptCompareOFF" MaintainScrollPositionOnPostback="True" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script src="../Scripts/select2.full.min.js"></script>    
            ...
            <script type="text/javascript">
                ...
                var NextPage2 = "ExcelCompareOFF??UID=<%= HttpContext.Current.Session["UID"] %>";
                var NextPage3 = "ChartCompareOFF??UID=<%= HttpContext.Current.Session["UID"] %>";
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="content-header">
        <ol class="breadcrumb">
            ...
            <li>Reports </li>
            <li class="active">Offshore Site Compare Report</li>
          </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class='box box-success'>
                    <div class="box-header">
                       <h3 class="box-title"><i class="fa fa-file-text "></i> Offshore Site Compare Report</h3>
                    </div>
                    <div class="box-body">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px; text-align: left; padding: 2px;">
                                        <asp:DropDownList ID="ddlCOMP" runat="server" Width="150px" CssClass="form-control select2">
                                            ...
                                            <asp:ListItem Value="GHV" Text="GHV(sat)"></asp:ListItem>
                                            <asp:ListItem Value="SG" Text="SG"></asp:ListItem>
                                            <asp:ListItem Value="H2O" Text="H2O"></asp:ListItem>
