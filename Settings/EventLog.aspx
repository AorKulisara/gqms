<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="EventLog.aspx.cs" Inherits="PTT.GQMS.USL.Web.Settings.EventLog" ValidateRequest="False" MaintainScrollPositionOnPostback="True" %>
...
<div class="col-md-5">
  <table border="0" class="text-black" style="border-collapse: separate; border-spacing: 0px">
        <tr>
						                                    <td style="width: 100px; height: 27px;text-align: right; padding: 2px;">Category&nbsp;:&nbsp;</td>
						                                    <td  style="width: 220px;">
							                                    <asp:DropDownList ID="cboCategory" runat="server" Width="300px" CssClass="form-control">
							                                    </asp:DropDownList>
							                                </td>
						                                </tr>
...
<div class="col-md-5">
  <table border="0" class="text-black" style="border-collapse: separate; border-spacing: 0px">
						                                <tr>
							                                <td style="width: 100px; height: 27px;text-align: right; padding: 2px;">Description&nbsp;:&nbsp;</td>
                ...
                <div class="box-body">
                      <asp:GridView ID="gvResult" runat="server" HorizontalAlign="Left" AutoGenerateColumns="False" DataKeyNames="" AllowPaging="True" GridLines="Both" PageSize="30" OnPageIndexChanging="gvResult_PageIndexChanging" OnRowDataBound="gvResult_RowDataBound" Width="100%">
					                    ...
					                    <Columns>
						                    ...
						                    <asp:BoundField DataField="EVENT_DETAIL" HeaderText="Description" HtmlEncode="False">
                                            <HeaderStyle Width="55%" CssClass="cell-center"></HeaderStyle>
