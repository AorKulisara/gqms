<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MainPage.Master" AutoEventWireup="true" CodeBehind="MngRoleList.aspx.cs" Inherits="PTT.GQMS.USL.Web.Settings.MngRoleList" ValidateRequest="False" MaintainScrollPositionOnPostback="True" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
      var NextPage = "MngRoleDetail?UID=<%= HttpContext.Current.Session["UID"] %>";
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-xs-4">
                            <table border="0" class="text-black" style="border-collapse: separate; border-spacing: 0px">
                                <tr>
                                    <td style="width: 100px; text-align: right;">Role name&nbsp;:&nbsp;</td>
                ...
                <div class="box">
                    <div class="box-body">
                        <asp:GridView ID="gvResult" runat="server" HorizontalAlign="Left" AutoGenerateColumns="False" DataKeyNames="" GridLines="Both" PageSize="30" OnRowDataBound="gvResult_RowDataBound" Width="100%">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Description" DataField="ROLE_DESC" SortExpression="ROLE_DESC">
