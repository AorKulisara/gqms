...
namespace PTT.GQMS.USL.Web.Master
{
    ...
    public partial class MngAnalysis : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            try
            {
                Name = Utility.FormatSearchData(Validation.GetCtrlStr(txtNAME));

                DT = Project.dal.SearchDimAnalysisMethod("", Name);
        ...
        protected void gvResult_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if ((e.Row.RowType == DataControlRowType.DataRow || e.Row.RowType == DataControlRowType.Separator))
                {
                    ...
                    e.Row.Attributes.Add("onclick", "javascript:DoAction('SELECT','" + Validation.EncodeParam(Utility.ToString(dr["ANLMET_ID"])) + "');");
                }
